...
/**
 * enterAlwaysCollapsed如何使用
 */
public class CollapsImageEnterAlwayCollActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.collapsing_image_enter_always_collas_activity);
